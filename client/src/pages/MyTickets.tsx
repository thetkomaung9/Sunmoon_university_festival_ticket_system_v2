...
export default function MyTicketsPage() {
  ...
  const { data: tickets, isLoading } = trpc.tickets.myTickets.useQuery(
    undefined,
        ...
        <div className="container py-20 max-w-md">
          <div className="rounded-lg border border-border bg-card p-8 text-center">
            ...
            <p className="mt-2 text-sm text-foreground/60">
              Your QR tickets are available after an admin approves your payment.
            </p>
            <Button
              asChild
      ...
      <div className="container py-10">
        ...
        {(tickets ?? []).length === 0 ? (
          <div className="mt-8 rounded-lg border border-border bg-card p-10 text-center">
            ...
            <p className="mt-2 text-sm text-foreground/60">
              Paid tickets appear here after admin payment verification.
            </p>
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      <Button asChild size="sm" className="bg-[var(--sunmoon-navy)] hover:bg-[var(--sunmoon-navy-deep)]">
                        <Link href={`/ticket/${ticket.ticketCode}`}>
