    ...
    <div className="min-h-screen bg-secondary/40 flex">
      ...
      <aside className="hidden lg:flex w-64 shrink-0 flex-col bg-[var(--sunmoon-navy)] text-white sticky top-0 h-screen">
        <div className="p-5 border-b border-white/10">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <div className="text-[10px] uppercase tracking-widest text-white/50">SMU Myanmar</div>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-white/10 text-xs text-white/50">
          <div className="font-medium text-white/80 truncate">{user.name ?? user.email}</div>
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    active ? "bg-white text-[var(--sunmoon-navy)]" : "bg-white/10 text-white/80"
                  )}
                >
                  {item.label}
                </Link>
